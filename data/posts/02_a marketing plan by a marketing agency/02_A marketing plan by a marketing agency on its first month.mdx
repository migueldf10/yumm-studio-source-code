...
type: article
slug: how create your first marketing plan
miniature: ./miniature.png
seo-title: How to create a marketing plan for a small growing business
...
-   Strategy pick, reasons behind - A classical value give - ask strategy - Channels and strong - weakness analysis - Roadmap
...
## Channels and traffic / client sources

Limit your war lines and focus on your best channels. So _Which ones are your best channels?_

Phase 1 - Test channels, paid and organic sources.

## Tracking

As you might now , we use Google Tag Manager to test and deploy all the event tracking and user behaviour experiments we perform in the site.

I separate all channels so you can see how are the thought around Yumm Studio V01, the launch project.

### GA - ALL DATA

We will use Google analytics as a main platform to understand user behaviour and multichannel conversion tracking.

### First test - LinkedIn
Organic traffic
Paid traffic + Full Conversion tracking
