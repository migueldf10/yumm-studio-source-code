---
title: Tech stack to enable rapid growth. All code included.
type: article
slug: Tech to growth hacking
seo-title: Tech stack to enable rapid growth hacking. [Code included]
...
_ If you have ** tech ** roles or tech bg, you can opt for a mixed solution, like shopify for CMS + Checkout tech but use a thing like gatsby to be faster than competition _
...
> It’s exactly whats going on with static site generators, they are the new kid on the block, faster, _more flexible_, cheaper, and will eventually eat all last century content managers, like Wordpress.
...
> By the way, in case this is the first time you come to this blog, this is a transparent company, which means all our choices, our code, our experiments and our failures are openly shared and discussed.  
> Subscribe to our newsletter and you will see our evolution in a weekly email ~or have a look from the past in here.~
