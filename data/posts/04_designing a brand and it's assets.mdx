---
title: Designing a brand for growing, the entire process with source files
type: article
slug: how to design a brand
seo-title: Designing a brand for growing, the process and source files
seo-description: From the idea to the design files
